package br.org.generation.oceani.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.oceani.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
			.title("API - Projeto Oceani")
			.description("Projeto API Spring - Oceani")
			.version("1.0.0")
			.license("Apache License Version 2.0")
			.licenseUrl("https://github.com/projetooceani/Oceani")
			.contact(contact())
			.build();
		}
		...
		private static Contact contact() {
			...
			return new Contact("Oceani",
			"https://github.com/projetooceani/Oceani",
			"Oceani@gmail.com");
